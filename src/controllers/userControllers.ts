...
const userController = {
  ...
  me: async (req: CustomRequest, res: Response): Promise<Response> => {
    ...
    mailForgotPassword: async (req: Request,res: Response): Promise<Response> => {
      ...
      try {
        ...
        await transporter.sendMail(mailOptions);res.json({ message:"Se envió un correo electrónico con instrucciones para restablecer la contraseña.",});
      } catch (error) {
        console.error(error);
